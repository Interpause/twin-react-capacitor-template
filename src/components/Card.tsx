/**
 * @file Everything about Cards. Adapted from https://github.com/interpause/interpause-components
			...
			<CardFooter className='footer'>
				{(() => {
					if (isValidElement(props.footer)) return props.footer
						...
						return <a href={props.href}>{props.footer}</a>
					else if ('onClick' in props && props.onClick)
						return <button onClick={props.onClick}>{props.footer}</button>
